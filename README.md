...
> **技術レビューと人格査定:** 技術は具体的に検証する。語彙や構想規模から開発者の正気度・人格・病理・悪意を査定しない。
...
> AIで「そこに霊がいる」と感じてもらうUXを作る。それが本当に実在するかの普遍的な証明はしない——できないんじゃなくて、IBD Coreが全Worldを横断して裁定できる手続きとして成立しない領域だから。科学、哲学、医学それぞれの領域で検討されるものであり、IBD Coreの裁定対象ではない。

> 体験の設計は本気でやる。中身の専門領域における真偽判定だけを、IBDが勝手に横取りしない。
...
## 9. 自我・存在論の非裁定とfact scope保持は必須要件
